...
- (void)sliderFirstTouch:(CharacterSelectView *)slider{
    self.leadingLayoutConstraint.constant = -(self.frame.size.width - slider.frame.size.width)/2.0f + 10;
    self.trailingLayoutContraint.constant = -(self.frame.size.width - slider.frame.size.width)/2.0f + 10;
