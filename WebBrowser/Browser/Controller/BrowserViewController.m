...
#define SYNTHESIZE_SINGLETON_FOR_CLASS(BrowserViewController);
...
- (void)viewDidLoad {
    ...
    [[DelegateManager init] registerDelegate:self forKeys:@[kDelegateManagerWebView, kDelegateManagerFindInPageBarDelegate]];
